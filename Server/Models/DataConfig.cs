...
public record DataConfig
{
    ...
    [JsonPropertyName("locationDefaults")] public LocationData<string> LocationDefaults { get; set; } = new();
...
public record Faction
{
    ...
    [JsonPropertyName("distanceMult")] public float DistanceMult { get; set; }
